...
#data = """Zach would gain 12 happiness units by sitting next to Kassie.
#Kassie would lose 10 happiness units by sitting next to Zach."""
...
class DirectedGraph:
	...
	def traverse(self, visited=[]):
		...
		if len(visited) == len(self.nodes):
			...
			full_circle = visited[:]
			full_circle.append(visited[0])
			d = 0
			for i in range(len(full_circle)-1):
