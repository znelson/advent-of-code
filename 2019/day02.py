...
for a in xrange(0, 100):
	for b in xrange(0, 100):
		...
		if tape[0] == 19690720:
			result = 100 * a + b
			print('{0}, expected {1}'.format(result, test_results[1]))
			break